...
use Drupal\bannermodal\Entity\BannerModal;


/**
 * Provides dynamic permissions for Banner modal of different types.
 *
 * @ingroup bannermodal
 *
 */
class BannerModalPermissions{
   ...
   *
   * @return array
   *   The BannerModal by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (BannerModal::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\bannermodal\Entity\BannerModal $type
   *   The BannerModal type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(BannerModal $type) {
    $type_id = $type->id();
